            ...
            <div className="space-y-4">
              ...
              {objet.poids !== undefined && (
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium">{objet.poids} kg</p>
                  </div>
                </div>
              )}
              ...
              {objet.note && (
                <div className="space-y-1">
                  ...
                  <p className="text-sm leading-relaxed">{objet.note}</p>
                </div>
              )}
                ...
                <div>
                  ...
                  {visiteur ? (
                    <button
                      ...
                      onClick={() => router.push(`/visiteurs/${visiteur.id}`)}
                    >
                      {visiteur.civilite} {visiteur.prenom}{" "}
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    value={form.statut}
                    onValueChange={(v) =>
                      setForm((f) => ({ ...f, statut: v as StatutObjet }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                    ...
                    <SelectContent>
                      {(
                        Object.entries(STATUTS_OBJET) as [
                          StatutObjet,
                ...
                {/* Avis du bénévole */}
                <div className="space-y-1.5">
                  <Label htmlFor="avisBenevole">Avis du bénévole</Label>
                  <Textarea
                    id="avisBenevole"
                    ...
                    onChange={(e) =>
                      setForm((f) => ({ ...f, avisBenevole: e.target.value }))
                    }
                  />
                </div>
                ...
                {/* Pièce à commander */}
                <div className="space-y-1.5">
                  <Label htmlFor="pieceACommander">Pièce à commander</Label>
                  <Input
                    id="pieceACommander"
